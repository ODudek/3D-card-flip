...
class SCFlipCard extends HTMLElement {
    ...
    flip() {
        ...
        const umbra = [
            ...
            { opacity: 0, transform: `translateY(62px) rotate${this._axis}(0deg)`, offset: 0.15 },
            { opacity: 0, transform: `translateY(62px) rotate${this._axis}(180deg)`, offset: 0.65 },
            { opacity: 0.3, transform: `translateY(2px) rotate${this._axis}(180deg)` },
        ];

        const penumbra = [
            { opacity: 0, transform: `translateY(2px) rotate${this._axis}(0deg)` },
            ...
            { opacity: 0, transform: `translateY(2px) rotate${this._axis}(180deg)` },
        ];
        ...
        this._penumbra.animate(penumbra, timing)
            .onfinish = _ => {
                ...
                this._side = (this._side === SCFlipCard.SIDES.FRONT) ?
                    SCFlipCard.SIDES.BACK : SCFlipCard.SIDES.FRONT;
            };
    }
